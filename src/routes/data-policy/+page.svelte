...
<div class="mx-auto max-w-3xl px-4 py-12 sm:px-6">
	...
	<div class="mt-8 space-y-6 text-sm leading-relaxed text-heading">
		...
		<section>
			<h2 class="text-lg font-semibold text-heading">Storage & retention</h2>
			<p class="mt-2 text-muted">
				Data is stored securely and kept only as long as the account or campaign it belongs to is
				active. Verification documents are retained for the review trail and removed on account
				deletion.
			</p>
		</section>
		<section>
			<h2 class="text-lg font-semibold text-heading">Third parties</h2>
			<p class="mt-2 text-muted">
				We use service providers for messaging (SMS, WhatsApp, email) and payments; each receives
				only the minimum needed to deliver its service. We do not sell personal data.
			</p>
		</section>
		<section>
			<h2 class="text-lg font-semibold text-heading">Access, correction, deletion</h2>
			<p class="mt-2 text-muted">
