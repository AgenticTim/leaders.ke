...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6">
	...
	<div class="mt-8 space-y-6 text-sm leading-relaxed text-heading">
		<section>
			<h2 class="text-lg font-semibold text-heading">The platform fee</h2>
		...
		<section>
			<h2 class="text-lg font-semibold text-heading">What campaigns agree to</h2>
			<ul class="mt-2 list-disc space-y-1 pl-5 text-muted">
				<li>Donations may only fund the campaign named on the page that collected them.</li>
				<li>
					The campaign is responsible for its own compliance with the Election Campaign Financing
					Act and any IEBC spending and disclosure rules that apply to its race.
				</li>
				<li>
					The fundraising goal and running total shown on the campaign page must reflect the
					campaign's honest position; the confirm step exists so the ledger matches money actually
					received.
				</li>
			</ul>
		</section>
		<section>
			<h2 class="text-lg font-semibold text-heading">What donors should know</h2>
			<ul class="mt-2 list-disc space-y-1 pl-5 text-muted">
				...
				<li>
					Today, donations are sent via M-Pesa and confirmed manually by the campaign team;
					automated STK push checkout is coming.
				</li>
			</ul>
		</section>
		<section>
			<h2 class="text-lg font-semibold text-heading">Questions</h2>
			<p class="mt-2 text-muted">
				Fee disputes or refund escalations: reach us through the
				<a href="/contact-us" class="font-medium text-primary hover:underline">Contact Us page</a>.
			</p>
		</section>
	</div>
</div>
